...
All file paths should use fully qualified absolute system paths (e.g., /home/user/project/src/file.ts).

### Shell Tool
- execute: Run shell commands in the workspace directory

The execute tool runs commands directly in the sandbox. Use it for:
...
/**
 * Generate system prompt with workspace context
 */
export function generateSystemPrompt(workspacePath: string): string {
  return `${BASE_SYSTEM_PROMPT}

# Workspace Context

You are working in a cloud sandbox environment.
Working directory: ${workspacePath}

All file paths should be relative to or within this working directory.
`
}
